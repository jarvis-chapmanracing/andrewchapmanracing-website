...
- Save the lead research context used for outreach, and save email drafts in a durable place outside Google Sheets so they are not lost in summaries or chat. Use local workspace files for durable storage. Drafts should be trackable with status such as pending approval, approved, sent, or rejected.
